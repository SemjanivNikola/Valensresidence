...
export default new Vuex.Store({
    state: {
        ...
        mobaDev: false,
        mainPhotos: [
            {id: 1, url: imgM1, alt: 'Valens Residence front view, entrence, parking'},
            {id: 2, url: imgM2, alt: 'Valens Residence kitchen'},
            {id: 3, url: imgM3, alt: 'Valens Residence dining area with a kitchen table'},
            ...
            {id: 11, url: imgM11, alt: 'Valens Residence at night. View at the parking'},
            {id: 12, url: imgM12, alt: 'View at the pool and sun beds'},
            {id: 13, url: imgM13, alt: 'View at the back side of Valens Residence'}
        ],
        gallery: [
            {id: 1, src: img1, alt: 'Valens Residence Croatian villa', block: 1, isActive: false, width: 0},
            {id: 2, src: img2, alt: 'Valens Residence Croatian villa', block: 1, isActive: false, width: 0},
            {id: 3, src: img3, alt: 'Valens Residence Croatian villa', block: 1, isActive: false, width: 0},
            {id: 4, src: img4, alt: 'Valens Residence Croatian villa', block: 1, isActive: false, width: 0},
            {id: 5, src: img5, alt: 'Valens Residence Croatian villa', block: 1, isActive: false, width: 0},
            {id: 6, src: img6, alt: 'Valens Residence Croatian villa', block: 1, isActive: false, width: 0},
            {id: 7, src: img7, alt: 'Valens Residence Croatian villa', block: 1, isActive: false, width: 0},
            {id: 8, src: img8, alt: 'Valens Residence Croatian villa', block: 1, isActive: false, width: 0},
            {id: 9, src: img9, alt: 'Valens Residence Croatian villa', block: 1, isActive: false, width: 0},
            {id: 10, src: img10, alt: 'Valens Residence Croatian villa', block: 1, isActive: false, width: 0},
            {id: 11, src: img11, alt: 'Valens Residence Croatian villa', block: 1, isActive: false, width: 0},
            {id: 12, src: img12, alt: 'Valens Residence Croatian villa', block: 1, isActive: false, width: 0},
            {id: 13, src: img13, alt: 'Valens Residence Croatian villa', block: 1, isActive: false, width: 0},
            {id: 14, src: img14, alt: 'Valens Residence Croatian villa', block: 1, isActive: false, width: 0},
            {id: 15, src: img15, alt: 'Valens Residence Croatian villa', block: 1, isActive: false, width: 0},
            {id: 16, src: img16, alt: 'Valens Residence Croatian villa', block: 1, isActive: false, width: 0},
            {id: 17, src: img17, alt: 'Valens Residence Croatian villa', block: 2, isActive: false, width: 0},
            {id: 18, src: img18, alt: 'Valens Residence Croatian villa', block: 2, isActive: false, width: 0},
            {id: 19, src: img19, alt: 'Valens Residence Croatian villa', block: 3, isActive: false, width: 0},
            {id: 20, src: img20, alt: 'Valens Residence Croatian villa', block: 3, isActive: false, width: 0},
            {id: 21, src: img21, alt: 'Valens Residence Croatian villa', block: 3, isActive: false, width: 0},
            {id: 22, src: img22, alt: 'Valens Residence Croatian villa', block: 3, isActive: false, width: 0},
            {id: 23, src: img23, alt: 'Valens Residence Croatian villa', block: 3, isActive: false, width: 0},
            {id: 24, src: img24, alt: 'Valens Residence Croatian villa', block: 3, isActive: false, width: 0},
            {id: 25, src: img25, alt: 'Valens Residence Croatian villa', block: 3, isActive: false, width: 0},
            {id: 26, src: img26, alt: 'Valens Residence Croatian villa', block: 3, isActive: false, width: 0},
            {id: 27, src: img27, alt: 'Valens Residence Croatian villa', block: 4, isActive: false, width: 0},
            {id: 28, src: img28, alt: 'Valens Residence Croatian villa', block: 4, isActive: false, width: 0},
            {id: 29, src: img29, alt: 'Valens Residence Croatian villa', block: 4, isActive: false, width: 0},
            {id: 30, src: img30, alt: 'Valens Residence Croatian villa', block: 4, isActive: false, width: 0},
            {id: 31, src: img31, alt: 'Valens Residence Croatian villa', block: 4, isActive: false, width: 0},
            {id: 32, src: img32, alt: 'Valens Residence Croatian villa', block: 4, isActive: false, width: 0},
            {id: 33, src: img33, alt: 'Valens Residence Croatian villa', block: 4, isActive: false, width: 0},
            {id: 34, src: img34, alt: 'Valens Residence Croatian villa', block: 1, isActive: false, width: 0},
            {id: 35, src: img35, alt: 'Valens Residence Croatian villa', block: 1, isActive: false, width: 0},
            {id: 36, src: img36, alt: 'Valens Residence Croatian villa', block: 5, isActive: false, width: 0},
            {id: 37, src: img37, alt: 'Valens Residence Croatian villa', block: 5, isActive: false, width: 0},
            {id: 38, src: img38, alt: 'Valens Residence Croatian villa', block: 6, isActive: false, width: 0},
            {id: 39, src: img39, alt: 'Valens Residence Croatian villa', block: 6, isActive: false, width: 0},
            {id: 40, src: img40, alt: 'Valens Residence Croatian villa', block: 6, isActive: false, width: 0},
            {id: 41, src: img41, alt: 'Valens Residence Croatian villa', block: 6, isActive: false, width: 0},
            {id: 42, src: img42, alt: 'Valens Residence Croatian villa', block: 6, isActive: false, width: 0},
        ],
        months: [
        ...
        hr: {
            ...
            main: {
                ...
                cards: [
                    {id: 1, img: imgA2, headline: 'Prostor za blagovanje', info: '10 osoba', overlayText: 'nutarnji i vanjski prostor, oboje za 10 ljudi'},
                    {id: 2, img: imgA11, headline: 'Knjižnica', info: '150+ knjiga', overlayText: 'Mnoge hrvatske knjige, prevedene na nekoliko jezika'},
                    {id: 3, img: imgA10, headline: 'Vinska polica', info: 'Sa šankom', overlayText: 'Kušajte neke od najpopularnijih hrvatskih vina i craft piva'},
                    {id: 4, img: imgA1, headline: 'Spavaće sobe', info: '4 queensize kreveta', overlayText: '4 potpuno opremljene spavaće sobe sa en-suitekupaonicama'},
                    {id: 5, img: imgA8, headline: 'Parking', info: '2', overlayText: 'U hladu, zaštićeni od sunca'},
                    {id: 6, img: imgA5, headline: 'Okoliš', info: '400 m2 prostora', overlayText: 'i dodatnih 220m2 terase'},
                    {id: 7, img: imgA12, headline: 'Broj gostiju', info: '8', overlayText: '4 potpuno opremljene spavaće sobe, svaka za 2 osobe'},
                    {id: 8, img: imgA4, headline: 'Kupaonica / WC', info: '4 + 2', overlayText: '4 en-suite kupaonice, 1 individualni i jedan gostinjski WC'},
                    {id: 9, img: imgA7, headline: 'Internet i TV', info: 'Besplatan internet i 6 TV-a', overlayText: 'Osiguran besplatan Wi-Fi na cijeloj površini vile, TV u svakoj spavaćoj sobi i 2 u zajedničkim prostorijama'},
                    {id: 10, img: imgA3, headline: 'Mini-golf teren', info: 'Rekreativnost', overlayText: '5 rupi na 65 m2'},
                    {id: 11, img: imgA9, headline: 'Bazen', info: '50m2, grijan', overlayText: 'Suvremena tehnologija za manje upotrebe kemikalija'},
                    {id: 12, img: imgA6, headline: 'Zabava', info: 'Teretana, spa i bilijar', overlayText: 'Teretana je potpuno opremljena, a finska sauna sadrži i kišni tuš'}
                ],
                services: [
                    {id: 1, numOrder: '#1', text: 'Transferi gostiju', desc: 'Po dogovoru pokupiti ćemo naše goste bez obzira na to kako dolaze. Prijevoz od/do zračne luke, pratnja od izlaza s autoceste ili najam morskog doka i prijevoz do vile - sve je u našoj moći! Jednostavno se morate pojaviti - ostalo je naše da se pobrinemo!', img: imgSgt},
                    {id: 2, numOrder: '#2', text: 'Dnevno čišćenje i pospremanje', desc: 'Ako ostanete tjedan dana ili više, na raspolaganju su vam naše spremačice kako bi vaš odmor učinili potpuno bezbrižnim, bez obzira želite li ih svaki dan ili po potrebi. *potrebna prethodna najava', img: imgScs},
                    {id: 3, numOrder: '#3', text: 'Catering', desc: 'Suradnja s prepoznatljivim konobama koje nude najbolje od tradicionalne kuhinje omogućila nam je da pred vama imamo samo najbolja, ukusna i tradicionalna istarska i mediteranska jela. *potrebna prethodna najava', img: imgSfc},
                    {id: 4, numOrder: '#4', text: 'Konsijerž ', desc: 'Za sve vas koji se želite potpuno opustiti i biti bezbrižni - na raspolaganju su vam naši asistenti. Biti će spremni prihvatiti gotovo svaku želju, uz najavu prije dolaska, a neke i po dolasku. Bez obzira želite li otići na izlet, u kazalište, zvjezdarnicu ili unajmiti jedrilicu, oni će učiniti sve da vam to omoguće.', img: imgSc},
                    {id: 5, numOrder: '#5', text: 'Organizacija događaja', desc: 'Valens Residence savršeno je mjesto za razne događaje do 50 ljudi. Naši stručni organizatori pomoći će vam da vaš događaj, proslava, snimanje ili čak promocija proizvoda bude zabavna i besprijekorna u 100% hrvatskom okruženju i uz spektakularnu pozadinu istarskog okruženja.', img: imgSeo},
                ],
            ...
            contactUs: {
                ...
                inquiry: {
                    ...
                    eventInfo: {
                        ...
                        warning: 'Sva polja je potrebno ispravno popuniti. Provjerite kalendar i ispravnost podataka te pokušajte ponovno!',
                        error: 'Nešto je pošlo krivo. Molim Vas, osvježite stranicu te pokušajte ponovno!'
                    }
                }
            },
            footer: {
            ...
            gallery: ['Sve', 'Okoliš', 'Kuhinja', 'Dnevni boravak', 'Sobe', 'Kupaonice', 'Zabava']
        },
        eng: {
            key: 2,
            ...
            main: {
                ...
                cards: [
                    {id: 1, img: imgA2, headline: 'Dining area', info: '10 people', overlayText: 'Inside and outside areas both for 10 people'},
                    {id: 2, img: imgA11, headline: 'Library', info: '150+ books', overlayText: ' Many of Croatian books translated on several languages'},
                    {id: 3, img: imgA10, headline: 'Vine cellar', info: 'With bar', overlayText: 'Taste some of most popular Croatian vines and craft beers'},
                    {id: 4, img: imgA1, headline: 'Bedrooms', info: '4 queensize bed', overlayText: '4 fully equipped bedrooms with en-suite bathroom'},
                    {id: 5, img: imgA8, headline: 'Parking', info: '2', overlayText: 'Shaded and sun protected '},
                    {id: 6, img: imgA5, headline: 'Exterior', info: '400 sqm living', overlayText: 'And 220 sqm of terrace '},
                    {id: 7, img: imgA12, headline: 'Number of people', info: '8', overlayText: '4 queen-size fully equipped bedrooms for 2 persons'},
                    {id: 8, img: imgA4, headline: 'Bathroom / toilet', info: '4 + 2', overlayText: '4-ensuite bathrooms, 1 individual and one guest toilet'},
                    {id: 9, img: imgA7, headline: 'Internet and TV', info: 'Free wiﬁ and 6 TVs', overlayText: 'Secured free wiﬁ around estate; tv in each bedroom and 2 in common areas'},
                    {id: 10, img: imgA3, headline: 'Mini golf teren', info: 'Recreative', overlayText: '5 holes on 65 sqm'},
                    {id: 11, img: imgA9, headline: 'Pool', info: '50 sqm heated', overlayText: 'Modern technology for less chemical usage, heated'},
                    {id: 12, img: imgA6, headline: 'Entertainment ', info: 'Gym, spa and pool table', overlayText: 'Gym is fully equipped and Finnish sauna has raindrop shower'},
                ],
                services: [
                    {id: 1, numOrder: '#1', text: 'Guest Transfers', desc: 'By appointment, we will pick up our guests no matter how they\'re coming.Picking up from/to the airport, car escorting from the highway exit, or rent a sea dock and transport to the villa - it\'s all in our power! You just have to show up - the rest is ours to be worried about!', img: imgSgt},
                    {id: 2, numOrder: '#2', text: 'Daily Cleaning Service', desc: 'If you\'re staying one week or more, our cleaners are at your disposal to make your holiday completely carefree, whether you want them every day or as needed. \n *prior notice required', img: imgScs},
                    {id: 3, numOrder: '#3', text: 'Catering', desc: 'Cooperation with recognisable taverns that offer the best of traditional cuisine has allowed us to have only the best, delicious and traditional Istrian and Mediterranean dishes at your door. *prior notice required', img: imgSfc},
                    {id: 4, numOrder: '#4', text: 'Concierge', desc: ' For all of you who wants to completely relax and be carefree - we have a concierges at your service. They will be ready to take almost any wish, with notice prior arrival. Whether you want to go on a trip, to the theatre, an observatory or rent a sailboat, they will do everything to make it possible for you.', img: imgSc},
                    {id: 5, numOrder: '#5', text: 'Event organisation', desc: 'The Valens Residence is the perfect setting for various events up to 50 people. Our expert organisers will help you with your next event, celebration, ﬁlming, shooting or product promotion to be beautiful and seamless in 100% Croatian environment and with the spectacular backdrop of Istrian surroundings.', img: imgSeo}
                ],
            ...
            contactUs: {
                ...
                eventInfo: {
                    ...
                    warning: 'All fields are required, as well as, calendar days, so make sure you type everything right and did not skip some!',
            ...
            gallery: ['All', 'Outside', 'Kitchen', 'Living room', 'Bedrooms', 'Bathrooms', 'Entertainment']
        }
    },
    mutations: {
